...
module.exports = BaseClass.extend({
  ...
  addAngularDefinition: function(options) {
    ...
    var angularDefinition = "module." + options.type + "('" + Case.camel(options.name) + "', " + Case.pascal(options.name)  + ");"
  ...
  addModuleImport: function(options) {
    ...
    var importStatement = "import " + Case.pascal(options.identifier) + " from '" + moduleImportPath + "';"
